...
var submitAnswer_Q5 = function() {
  ...
  if ( val == "Noun" ) {
    document.getElementById("QUESTION-VALIDATE-Wrong-Q5").innerHTML = "";
    document.getElementById("QUESTION-NONE-Q5").innerHTML = "";
    ...
    document.getElementById("QUESTION-VALIDATE-Wrong-Q5").innerHTML = "";
    document.getElementById("QUESTION-VALIDATE-Q5").innerHTML = "";
...
var submitAnswer_Q6 = function() {
  ...
  if ( val == "Verb" ) {
    document.getElementById("QUESTION-VALIDATE-Wrong-Q6").innerHTML = "";
    document.getElementById("QUESTION-NONE-Q6").innerHTML = "";
    ...
    document.getElementById("QUESTION-VALIDATE-Wrong-Q6").innerHTML = "";
    document.getElementById("QUESTION-VALIDATE-Q6").innerHTML = "";
...
var submitAnswer_Q7 = function() {
  ...
  if (val == "Nickel" || val == "nickel" || val == "NICKEL") {
  document.getElementById("QUESTION-VALIDATE-Wrong-Q7").innerHTML = "";
    document.getElementById("QUESTION-NONE-Q7").innerHTML = "";  
    ...
    document.getElementById("QUESTION-VALIDATE-Q7").innerHTML = "";
    document.getElementById("QUESTION-NONE-Q7").innerHTML = "";
...
var submitAnswer_Q8 = function() {
  ...
  if ( val == "Lamb" || val == "lamb" || val == "LAMB" ) {
    document.getElementById("QUESTION-VALIDATE-Wrong-Q8").innerHTML = "";
    document.getElementById("QUESTION-NONE-Q8").innerHTML = "";
    ...
    document.getElementById("QUESTION-VALIDATE-Wrong-Q8").innerHTML = "";
    document.getElementById("QUESTION-VALIDATE-Q8").innerHTML = "";
